                          ...
                          {section.options.map((option, optionIdx) => (
                            ...
                            >
                              <input
                                ...
                                value={option.value} // Use value instead of defaultValue for radios
                                checked={option.checked} // Use checked for controlled radio buttons
                                id={`filter-${section.id}-${optionIdx}`}
                                name={section.id} // All radios in the same group share the same name
